                ...
                <div class="row">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <div class="row matchRow ">
                            ...
                            <div class="matchData userName <?php echo $row2["userName"]; ?> col-lg-4 col-md-4 col-sm-4 col-xs-4 <?php if($row["player_id"] == $row["p1_id"]){ echo strtolower($row["p1_char"]);} else { echo strtolower($row["p2_char"]);} ?>">
